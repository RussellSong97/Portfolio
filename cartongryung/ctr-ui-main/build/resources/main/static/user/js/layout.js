function layoutEvent() {
	...
	// 헤더 배너
	document.querySelector('.banner-top .btn-close')?.addEventListener('click', function() {
		const banner = document.querySelector('.banner-top');
		banner.style.cssText = 'height: 0; padding: 0;';
	});
	...
	$('.quick-wrap .info-wrap .img').on('click', function () {
	...
	$('.quick-wrap .info-wrap .info-box').on('click', function (event) {
