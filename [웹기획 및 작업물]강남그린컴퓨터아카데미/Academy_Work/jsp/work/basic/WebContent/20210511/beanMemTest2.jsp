...
<body>
	...
	<table>
		<tr>
			<th>아이디</th><td><%=mem.getUid() %>(<jsp:getProperty name="mem" property="uid" />)</td>
		</tr>
		<tr>
			<th>암호</th><td><%=mem.getPwd() %>(<jsp:getProperty name="mem" property="pwd" />)</td>
		</tr>
		<tr>
			<th>이름</th><td><%=mem.getName() %>(<jsp:getProperty name="mem" property="name" />)</td>
		</tr>
		<tr>
			<th>전화</th><td><%=mem.getPhone() %>(<jsp:getProperty name="mem" property="phone" />)</td>
		</tr>
		<tr>
			<th>포인트</th><td><%=mem.getPoint() %>(<jsp:getProperty name="mem" property="point" />)</td>
		</tr>
	</table>
</body>
</html>
