...
<body>
	<h2>회원 정보 입력 폼</h2>
	<form name="frmJoin" action="joinProc.jsp" method="post" onsubmit="return chkValue(this);">
		...
		<table border="1" cellpadding="5" width="700">
			...
			<tr>
				...
				<td>
					...
					<input type="radio" name="mi_issns" value="n" />미수신</td>
			</tr>
		...
		<table border="1" cellpadding="5" width="700" >
			<tr>
				<th width="20%">우편번호</th>
				<td width="*"><input type="text" name="ma_zip" size="5" mexlength="5" /></td>
			</tr>
			<tr>
				<th>주소</th>
				<td>
					<input type="text" name="ma_addr1" />
					<input type="text" name="ma_addr2" />
				</td>
			</tr>
		</table>
